...
def args_parser():
    ...
    parser.add_argument('--participant_num', type=int, default=6040, help="number of participant in pre-experiment")
    ...
    parser.add_argument('--learning_rate', type=float, default=1e-4, help="client's learning rate")
