...
def args_parser():
    ...
    parser.add_argument('--candidate_num', type=int, default=20, help="number of candidate")
    parser.add_argument('--participant_num', type=int, default=10, help="number of participant in pre-experiment")
